...
class JoypadSpace(Wrapper):
	...
	def step(self, action):
		...
		"""
		# {0: 'NOOP', 1: 'right', 2: 'right A', 3: 'right B', 4: 'right A B', 5: 'A', 6: 'left', 7: 'left A', 8: 'left B', 9: 'left A B', 10: 'down', 11: 'up'
		# take the step and record the output
		# start = time.time()
		act = self._action_map[action]
		print(action, act)
		env = self.env.step(act)
		# img = Image.fromarray(env[0])
		# end = time.time()
        # img.save('my.png')
		# img.show()
		# print(env)
